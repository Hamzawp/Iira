...
export default function CompleteUpload(props) {
  ...
  return (
    <>
            ...
            <div className="inp-inpanddiv">
              <div className="collaborators">
                <h3 style={{ paddingLeft: "10px" }}>
                  Om Shete · Sakshi Bhandhari · Abhishek Uphadhyay
                </h3>
              </div>
            </div>
          </div>
          ...
          <div className="inp-container" style={{ rowGap: "0px" }}>
            ...
            <div className="inp-inpanddiv">
              ...
              <p style={{ paddingLeft: "10px" }}>
                BarterX is a very good project it is awesome has lots of
                features like buy sell and trade. It consists of a
                reccomendation Machine Learning Model as well as image to text
                convertor which is used in line with reccomendation of products
              </p>
            </div>
          </div>
        </div>
      ...
      <button class="completeBtn" onClick={() => uploadBtn(6)}>
        {" "}
        Upload Project
      </button>
    </>
